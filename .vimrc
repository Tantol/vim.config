...
" Quickfix windown
nnoremap <leader>qc :cclose<ENTER>
nnoremap <silent> [q :cn<ENTER>
nnoremap <silent> ]q :cp<ENTER>
" Exclude quickfix windown from buffers list
augroup qf
    autocmd!
...
" Display all buffers for airline
...
" Buffers managment switch / close
